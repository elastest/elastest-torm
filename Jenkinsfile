    node('TESTDOCKER'){
        ...
        stage "CI Container setup"
            ...
            try {
                ...
                mycontainer.inside("-u jenkins -p 37500:37500 -p 37501:37501 -p 37502:37502 -v /var/run/docker.sock:/var/run/docker.sock:rw -v ${WORKSPACE}:/home/jenkins/.m2 -v /home/ubuntu/.gnupg:/home/jenkins/.gnupg") {
