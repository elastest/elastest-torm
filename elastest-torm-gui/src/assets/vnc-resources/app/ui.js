    ...
    * ------v------*/
    ...
    addControlbarHandlers: function () {
        ...
        if (controlBar !== undefined && controlBar !== null) {
            controlBar.addEventListener('mousemove', UI.activateControlbar);
            controlBar.addEventListener('mouseup', UI.activateControlbar);
            controlBar.addEventListener('mousedown', UI.activateControlbar);
            controlBar.addEventListener('keypress', UI.activateControlbar);
            controlBar.addEventListener('mousedown', UI.keepControlbar);
            controlBar.addEventListener('keypress', UI.keepControlbar);
        }

        let viewDragButton = document.getElementById('noVNC_view_drag_button');
        if (viewDragButton !== undefined && viewDragButton !== null) {
            viewDragButton.addEventListener('click', UI.toggleViewDrag);
        }
    ...
    setMouseButtonListener: function (element, mouseBtn) {
        if (element !== undefined && element !== null) {
            element.addEventListener('click', function () { UI.setMouseButton(mouseBtn); });
        }
    },
    ...
    screenSize: function () {
        var screen = document.getElementById('vnc_screen');
    ...
    updateViewClip: function () {
        ...
        resizeSetting = hardcoded_resize;
    ...
    keyboardinputReset: function () {
        if (document.getElementById('noVNC_keyboardinput')) {
