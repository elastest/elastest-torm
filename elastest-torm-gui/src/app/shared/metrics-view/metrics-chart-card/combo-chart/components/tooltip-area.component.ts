...
export class TooltipAreaComponent {
  ...
  @Output() hover;
  @ViewChild('tooltipAnchor', { static: true }) tooltipAnchor;
  ...
  mouseMove = function(event, disable = false, point?) {
    if (point === undefined) {
    ...
    if (closestPoint !== undefined) {
      ...
      if (this.anchorPos !== this.lastAnchorPos) {
        let ev: MouseEvent = new MouseEvent('mouseleave', { bubbles: false });
  ...
  getToolTipText = function(tooltipItem) {
    var result = '';
