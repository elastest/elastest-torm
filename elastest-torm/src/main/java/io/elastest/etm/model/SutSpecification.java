...
public class SutSpecification {
	...
	@Id
	@JsonView({ SutView.class, BasicAttProject.class, ExternalProjectView.class, BasicAttTJob.class,
			ExternalTJobView.class, BasicAttTJobExec.class })
	...
	public SutSpecification(Long id, String name, String specification, String description, Project project,
			...
			InstrumentedByEnum instrumentedBy, String port, ManagedDockerType managedDockerType,
	...
	public SutSpecification(Long id, String name, String specification, String description, ExternalProject exProject,
			List<TJob> tJobs, SutTypeEnum sutType, boolean instrumentalize, Long currentSutExec,
			InstrumentedByEnum instrumentedBy, String port, ManagedDockerType managedDockerType,
			CommandsOptionEnum commandsOption) {
		this.id = id == null ? 0 : id;
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, sutSpecification.id) && Objects.equals(this.name, sutSpecification.name)
				...
				&& Objects.equals(this.managedDockerType, sutSpecification.managedDockerType)
				&& Objects.equals(this.mainService, sutSpecification.mainService)
				...
				&& Objects.equals(this.commandsOption, sutSpecification.commandsOption);
	}
	...
	public String toString() {
		...
		sb.append("    managedDockerType: ").append(toIndentedString(managedDockerType)).append("\n");
		sb.append("    mainService: ").append(toIndentedString(mainService)).append("\n");
		sb.append("    parameters: ").append(toIndentedString(parameters)).append("\n");
		sb.append("    commands: ").append(toIndentedString(commands)).append("\n");
		sb.append("    exProject: ").append(toIndentedString(exProject)).append("\n");
		sb.append("    exTJobs: ").append(toIndentedString(exTJobs)).append("\n");
		sb.append("    commandsOption: ").append(toIndentedString(commandsOption)).append("\n");
		sb.append("}");
		return sb.toString();
	}
