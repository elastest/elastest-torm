...
public class TestSuiteApiController implements TestSuiteApi {
	...
	private static final Logger logger = LoggerFactory.getLogger(TestSuiteApiController.class);
	...
	public ResponseEntity<List<TestSuite>> getTestSuitesByTJobExec(Long tJobId, Long execId) {
		List<TestSuite> testSuites = this.testSuiteService.getTestSuitesByTJobExec(execId);
	...
	public ResponseEntity<TestSuite> getTestSuiteById(
		...
		TestSuite testSuite = this.testSuiteService.getTestSuiteById(testSuiteId);
	...
	public ResponseEntity<List<TestCase>> getTestCasesByTestSuite(Long tJobId, Long execId, Long testSuiteId) {
		List<TestCase> testCases = this.testSuiteService.getTestCasesByTestSuiteId(testSuiteId);
