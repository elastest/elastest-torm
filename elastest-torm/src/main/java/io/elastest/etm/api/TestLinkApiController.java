...
public class TestLinkApiController implements TestLinkApi {
	...
	public ResponseEntity<TestProject[]> getAllTestProjects() {
		...
		return new ResponseEntity<TestProject[]>(testLinkService.getProjects(), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestProject> getProjectByName(
		...
		return new ResponseEntity<TestProject>(testLinkService.getProjectByName(projectName), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestProject> getProjectById(
		...
		return new ResponseEntity<TestProject>(testLinkService.getProjectById(projectId), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestProject> createProject(
		...
		try {
			...
			return new ResponseEntity<TestProject>(project, HttpStatus.CONFLICT);
		}
	}
	...
	public ResponseEntity<TestSuite> getTestSuiteById(
		...
		return new ResponseEntity<TestSuite>(testLinkService.getTestSuiteById(suiteId), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestSuite[]> getProjectTestSuites(
		...
		return new ResponseEntity<TestSuite[]>(testLinkService.getProjectTestSuites(projectId), HttpStatus.OK);
	...
	public ResponseEntity<TestCase> getTestcase(
		...
		return new ResponseEntity<TestCase>(testLinkService.getTestCaseById(caseId), HttpStatus.OK);
	}

	public ResponseEntity<TestCase[]> getSuiteTestCases(
			@ApiParam(value = "Id of Test Suite.", required = true) @PathVariable("suiteId") Integer suiteId) {
		return new ResponseEntity<TestCase[]>(testLinkService.getSuiteTestCases(suiteId), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestCase[]> getPlanTestCases(
		...
		return new ResponseEntity<TestCase[]>(testLinkService.getPlanTestCases(planId), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestPlan[]> getProjectTestPlans(
		...
		return new ResponseEntity<TestPlan[]>(testLinkService.getProjectTestPlans(id), HttpStatus.OK);
	}
	...
	public ResponseEntity<TestPlan> getPlanByName(
		...
		return new ResponseEntity<TestPlan>(testLinkService.getTestPlanByName(planName, projectName), HttpStatus.OK);
	}

	public ResponseEntity<TestPlan> getPlanById(
			@ApiParam(value = "Id of the plan.", required = true) @PathVariable("planId") Integer planId) {
		return new ResponseEntity<TestPlan>(testLinkService.getTestPlanById(planId), HttpStatus.OK);
	}
	...
	public ResponseEntity<Build> getLatestPlanBuild(
			@ApiParam(value = "Name of the project.", required = true) @PathVariable("projectName") String projectName,
			@ApiParam(value = "ID of the plan.", required = true) @PathVariable("planId") Integer planId) {
		return new ResponseEntity<Build>(testLinkService.getLatestPlanBuild(planId), HttpStatus.OK);
	}
	...
	public ResponseEntity<Execution[]> getAllExecs() {
		return new ResponseEntity<Execution[]>(testLinkService.getAllExecs(), HttpStatus.OK);
	}

	public ResponseEntity<Execution[]> getTestCaseExecs(
			@ApiParam(value = "Id of Test case.", required = true) @PathVariable("caseId") Integer caseId) {
		return new ResponseEntity<Execution[]>(testLinkService.getTestCaseExecs(caseId), HttpStatus.OK);
	}
	...
	public ResponseEntity<Execution> getTestExecById(
		...
		return new ResponseEntity<Execution>(testLinkService.getTestExecById(caseId, execId), HttpStatus.OK);
	...
	public ResponseEntity<Execution[]> getPlanTestCaseExecs(
			@ApiParam(value = "Id of Test Plan.", required = true) @PathVariable("planId") Integer planId,
			@ApiParam(value = "Id of Test case.", required = true) @PathVariable("caseId") Integer caseId) {
		return new ResponseEntity<Execution[]>(testLinkService.getPlanTestCaseExecs(planId, caseId), HttpStatus.OK);
	}

	public ResponseEntity<Execution[]> getBuildTestCaseExecs(
			@ApiParam(value = "ID of the build.", required = true) @PathVariable("buildId") Integer buildId,
			@ApiParam(value = "Id of Test case.", required = true) @PathVariable("caseId") Integer caseId) {
		return new ResponseEntity<Execution[]>(testLinkService.getBuildTestCaseExecs(buildId, caseId), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> getTestLinkUrl() {
		return new ResponseEntity<String>(testLinkService.getTestLinkUrl(), HttpStatus.OK);
	}

	public ResponseEntity<Boolean> syncTestLink() {
		return new ResponseEntity<Boolean>(testLinkService.syncTestLink(), HttpStatus.OK);
	}

	public ResponseEntity<ExternalProject> getExternalProjectByTestProjectId(
			@ApiParam(value = "ID of the project.", required = true) @PathVariable("projectId") Integer projectId) {
		return new ResponseEntity<ExternalProject>(testLinkService.getExternalProjectByTestProjectId(projectId),
				HttpStatus.OK);
	}

	public ResponseEntity<ExternalTJob> getExternalTJobByTestPlanId(
			@ApiParam(value = "ID of the plan.", required = true) @PathVariable("planId") Integer planId) {
		return new ResponseEntity<ExternalTJob>(testLinkService.getExternalTJobByPlanId(planId), HttpStatus.OK);
	}

	public ResponseEntity<ExternalTestCase> getExternalTestCaseByTestCaseId(
			@ApiParam(value = "ID of the Test Case.", required = true) @PathVariable("caseId") Integer caseId) {
		return new ResponseEntity<ExternalTestCase>(testLinkService.getExternalTestCaseByTestCaseId(caseId),
				HttpStatus.OK);
	}
