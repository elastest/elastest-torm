...
public interface SutApi extends EtmApiRoot {
    ...
    @ApiOperation(value = "Creates a new SuT Description", notes = "A SUT will be associated with a Project. "
            ...
            + "name, imageName, project, specification", response = SutSpecification.class, tags = {
                    "SUT", })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = SutSpecification.class),
            @ApiResponse(code = 405, message = "Invalid input") })
    @RequestMapping(value = "/sut", consumes = {
            "application/json" }, method = RequestMethod.POST)
    ResponseEntity<SutSpecification> createSuT(
            @ApiParam(value = "SUT configuration", required = true) @Valid @RequestBody SutSpecification body);

    @ApiOperation(value = "Deletes a SUT", notes = "Deletes the SUT whose id matches with a given id.", response = Long.class, tags = {
            "SUT", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/sut/{sutId}", produces = {
    ...
    @RequestMapping(value = "/sut/exec/{sutExecId}", produces = {
            "application/json" }, method = RequestMethod.DELETE)
    ResponseEntity<Long> deleteSuTExec(
            @ApiParam(value = "Id of the SUT Execution to delete.", required = true) @PathVariable("sutExecId") Long sutExecId);

    @ApiOperation(value = "Returns a SUT Execution.", notes = "Returns the SUT Execution whose id matches with a given id.", response = SutExecution.class, tags = {
            "SUT Execution", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/sut/{sutId}/exec/{sutExecId}", produces = {
            "application/json" }, method = RequestMethod.GET)
    ResponseEntity<SutExecution> getSutExec(
            @ApiParam(value = "Id of the SUT executed.", required = true) @PathVariable("sutId") Long sutId,
            @ApiParam(value = "Id of the SUT Execution.", required = true) @PathVariable("sutExecId") Long sutExecId);

    @ApiOperation(value = "List all SUT definitions", notes = "Returns a list of all SUT definitions.", response = SutSpecification.class, responseContainer = "List", tags = {
            "SUT", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/sut", produces = {
            "application/json" }, method = RequestMethod.GET)
    ResponseEntity<List<SutSpecification>> getSutList();

    @ApiOperation(value = "Updates an existing SUT Description", notes = "Updates a SUT with the request body data.", response = SutSpecification.class, tags = {
            "SUT", })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "OK", response = SutSpecification.class),
    ...
    ResponseEntity<SutSpecification> modifySut(
            @ApiParam(value = "SUT configuration", required = true) @Valid @RequestBody SutSpecification body);

    @ApiOperation(value = "List all SUT executions", notes = "Returns a list of all SUT Executions for a given SUT.", response = SutExecution.class, responseContainer = "List", tags = {
            "SUT Execution", })
    @ApiResponses(value = {
    ...
    @RequestMapping(value = "/sut/{sutId}/exec", produces = {
            "application/json" }, method = RequestMethod.GET)
    ResponseEntity<List<SutExecution>> getAllSutExecBySut(
            @ApiParam(value = "SUT id", required = true) @PathVariable("sutId") Long sutId);

    @ApiOperation(value = "Returns a SUT", notes = "Returns the SUT that matches for a given id.", response = SutSpecification.class, tags = {
            "SUT", })
    @ApiResponses(value = {
