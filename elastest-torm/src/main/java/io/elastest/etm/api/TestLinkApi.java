...
public interface TestLinkApi extends EtmApiRoot {
	...
	@RequestMapping(value = "/testlink/project", produces = { "application/json" }, method = RequestMethod.GET)
	...
	@ApiOperation(value = "Returns a Test Project By Given Name", notes = "Returns a Test Project By Given Name.", response = TestProject.class, tags = {
			"TestLink", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = TestProject.class),
			@ApiResponse(code = 404, message = "Resources not found") })
	...
	@RequestMapping(value = "/testlink/project", produces = { "application/json" }, consumes = {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = TestSuite.class),
			@ApiResponse(code = 405, message = "Invalid input"), @ApiResponse(code = 409, message = "Already exist") })
	@RequestMapping(value = "/testlink/project/{projectId}/suite", produces = { "application/json" }, consumes = {
			"application/json" }, method = RequestMethod.POST)
	...
	@ApiOperation(value = "Returns a Test plan", notes = "Returns a test plan by given name and project name.", response = TestPlan.class, tags = {
			"TestLink", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = TestPlan.class),
			@ApiResponse(code = 404, message = "Resources not found") })
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = TestPlan.class),
			@ApiResponse(code = 405, message = "Invalid input"), @ApiResponse(code = 409, message = "Already exist") })
	@RequestMapping(value = "/testlink/project/{projectId}/plan", produces = { "application/json" }, consumes = {
			"application/json" }, method = RequestMethod.POST)
	...
	@ApiResponses(value = {
			...
			@ApiResponse(code = 404, message = "Resources not found") })
	@RequestMapping(value = "/testlink/execs", produces = { "application/json" }, method = RequestMethod.GET)
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = String.class),
			@ApiResponse(code = 404, message = "Resources not found") })
	@RequestMapping(value = "/testlink/url", produces = { "application/json" }, method = RequestMethod.GET)
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = Boolean.class),
			@ApiResponse(code = 404, message = "Resources not found") })
	@RequestMapping(value = "/testlink/sync", produces = { "application/json" }, method = RequestMethod.GET)
