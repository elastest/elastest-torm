...
public interface TjobApi extends EtmApiRoot {
	...
	@ApiOperation(value = "Create a new TJob", notes = "Creates a new TJob associated with an existing project. This method,"
			+ " at least must receive as input a JSON with the following fields: TJob name, imageName, external and project.", response = TJob.class, tags = {
					"TJob", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Creation successful", response = TJob.class),
			@ApiResponse(code = 405, message = "Invalid input") })
	@RequestMapping(value = "/tjob", produces = { "application/json" }, consumes = {
	...
	@ApiOperation(value = "Deletes a TJob", notes = "Deletes the TJob identified by the received id.", response = Long.class, tags = {
			"TJob", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Deleteted successful", response = Long.class),
	...
	@RequestMapping(value = "/tjob", produces = { "application/json" }, method = RequestMethod.GET)
	...
	@ApiOperation(value = "Returns a TJob", notes = "Returns the TJob identified by the received id with all its detailed data.", response = TJob.class, tags = {
			"TJob", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = TJob.class),
			@ApiResponse(code = 400, message = "TJob not found.", response = TJob.class) })
	@RequestMapping(value = "/tjob/{tJobId}", produces = { "application/json" }, method = RequestMethod.GET)
	...
	@ApiOperation(value = "Modifies a existing TJob", notes = "Modifies the TJob that matches the received TJob.", response = TJob.class, tags = {
			"TJob", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "TJob Mofification Successful", response = TJob.class),
	...
	@ApiOperation(value = "Executes a TJob", notes = "Execute the TJob with the received id.", response = Long.class, tags = {
			"TJob Execution", })
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successful operation", response = TJobExecution.class),
			@ApiResponse(code = 400, message = "Invalid ID supplied"),
			@ApiResponse(code = 404, message = "TJob not found"), @ApiResponse(code = 500, message = "Server Error") })
	@RequestMapping(value = "/tjob/{tJobId}/exec", consumes = { "application/json" }, produces = {
			"application/json" }, method = RequestMethod.POST)
	...
	@RequestMapping(value = "/tjob/{tJobId}/exec", produces = { "application/json" }, method = RequestMethod.GET)
	...
	@ApiResponses(value = {
			@ApiResponse(code = 200, message = "Successful operation", response = TJobExecution.class, responseContainer = "List"),
			@ApiResponse(code = 404, message = "TJobs Executions not found") })
	@RequestMapping(value = "/tjob/execs", produces = { "application/json" }, method = RequestMethod.GET)
