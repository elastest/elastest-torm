...
public class EtSampleDataLoader {
	...
	public EtSampleDataLoader(EtDataLoader etDataLoader, ExternalService externalService, UtilsService utilsService) {
	...
	public boolean createData(boolean withForce) {
		try {
			String sampleDataCreated = (configFolder.endsWith("/") ? configFolder : configFolder + "/")
					+ "sampleDataCreated";
	...
	public void createUnitTests() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			String commands1 = "git clone https://github.com/elastest/demo-projects;\ncd " + junit5UnitProjectPath
					+ ";\nmvn -B test\n";

			etDataLoader.createTJob(project, tJob1Name, junit5UnitResultsPath, javaMvnImage, false, commands1,
					EXEC_DASHBOARD_CONFIG, null, null, null, null);

			/* *** TJob 2 *** */
			String tJob2Name = "JUnit4 Unit Test";
			String commands2 = "git clone https://github.com/elastest/demo-projects;\ncd " + junit4UnitProjectPath
					+ ";\nmvn -B test\n";

			etDataLoader.createTJob(project, tJob2Name, junit4UnitResultsPath, javaMvnImage, false, commands2,
					EXEC_DASHBOARD_CONFIG, null, null, null, null);
			...
			String commands3 = "git clone https://github.com/elastest/demo-projects;\ncd " + pythonUnitProjectPath
					+ ";\npython UnitTest.py;";

			etDataLoader.createTJob(project, tJob3Name, pythonUnitResultsPath, pythonImage, false, commands3,
					EXEC_DASHBOARD_CONFIG, null, null, null, null);

			/* *** TJob 4 *** */
			String jasmineUnitProjectPath = unitTestFolder + "/jasmine-unit-test";
			String jasmineUnitResultsPath = jasmineUnitProjectPath + jasmineAndProtractorRelativeResultsPath;

			String tJob4Name = "Jasmine Unit Test";

			String commands4 = "git clone https://github.com/elastest/demo-projects;\ncd " + jasmineUnitProjectPath
					+ ";\njasmine;";

			etDataLoader.createTJob(project, tJob4Name, jasmineUnitResultsPath, nodeImage, false, commands4,
					EXEC_DASHBOARD_CONFIG, null, null, null, null);
		}
	}
	...
	public void createRestApi() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			SutSpecification sut = etDataLoader.createSutDeployedByElastestWithDockerImage(project, null, sutName,
					sutDesc, sutImage, sutProtocol, sutPort, null);
			...
			String commands1 = "git clone https://github.com/elastest/demo-projects;\ncd " + junit5RestProjectPath
					+ ";\nmvn -B test;";

			etDataLoader.createTJob(project, tJob1Name, junit5RestResultsPath, javaMvnImage, false, commands1,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, null, sut, null);

			/* *** TJob 2 *** */
			String tJob2Name = "JUnit4 Rest Test";
			String commands2 = "git clone https://github.com/elastest/demo-projects;\ncd " + junit4RestProjectPath
					+ ";\nmvn -B test;";

			etDataLoader.createTJob(project, tJob2Name, junit4RestResultsPath, javaMvnImage, false, commands2,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, null, sut, null);
			...
			String commands3 = "git clone https://github.com/elastest/demo-projects;\ncd " + karateRestProjectPath
					+ ";\nmvn -B test;";

			etDataLoader.createTJob(project, tJob3Name, karateRestResultsPath, javaMvnImage, false, commands3,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, null, sut, null);

			/* *** TJob 4 *** */
			String jasmineRestProjectPath = restTestFolder + "/jasmine-rest-test";
			String jasmineRestResultsPath = jasmineRestProjectPath + jasmineAndProtractorRelativeResultsPath;
			...
			etDataLoader.createTJob(project, tJob4Name, jasmineRestResultsPath, nodeImage, false, commands4,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, null, sut, null);
			...
			String commands5 = "git clone https://github.com/elastest/demo-projects;\ncd " + pythonRestProjectPath
					+ ";\npython RestTest.py;";

			etDataLoader.createTJob(project, tJob5Name, pythonRestResultsPath, pythonImage, false, commands5,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, null, sut, null);
		}
	}
	...
	public void createWebapp() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			// Create Sut
			SutSpecification sut = etDataLoader.createSutDeployedByElastestWithDockerImage(project, null, webAppSutName,
					webAppSutDesc, webAppSutImage, webAppSutProtocol, webAppSutPort, null);
			...
			String junit5MultipleBrowsersProjectPath = webAppFolder + "/junit5-web-multiple-browsers-test";
			String junit5MultipleBrowsersResultsPath = junit5MultipleBrowsersProjectPath + javaRelativeResultsPath;

			String junit5SingleBrowserProjectPath = webAppFolder + "/junit5-web-single-browser-test";
			String junit5SingleBrowserResultsPath = junit5SingleBrowserProjectPath + javaRelativeResultsPath;

			/* *** TJob 1 *** */
			String tJob1Name = "JUnit5 Multi Browser Test";
			String commands1 = "git clone https://github.com/elastest/demo-projects;\ncd "
					+ junit5MultipleBrowsersProjectPath + ";\nmvn -B -Dbrowser=chrome test;";
			etDataLoader.createTJob(project, tJob1Name, junit5MultipleBrowsersResultsPath, javaMvnImage, false,
			...
			etDataLoader.createTJob(project, tJob2Name, junit5MultipleBrowsersResultsPath, javaMvnImage, false,
					commands2, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);

			/* *** TJob 3 *** */
			String tJob3Name = "JUnit5 Single Browser Test";
			String commands3 = "git clone https://github.com/elastest/demo-projects;\ncd "
					+ junit5SingleBrowserProjectPath + ";\nmvn -B -Dbrowser=chrome test;";
			etDataLoader.createTJob(project, tJob3Name, junit5SingleBrowserResultsPath, javaMvnImage, false, commands3,
			...
			multiConfigs.add(new MultiConfig("BROWSER", new ArrayList<String>(Arrays.asList("chrome", "firefox"))));

			etDataLoader.createTJob(project, tJob4Name, junit5MultipleBrowsersResultsPath, javaMvnImage, false,
					commands4, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, multiConfigs);

			/* ************************************** */
			/* *************** Junit4 *************** */
			/* ************************************** */

			String junit4MultipleBrowsersProjectPath = webAppFolder + "/junit4-web-multiple-browsers-test";
			String junit4MultipleBrowsersResultsPath = junit4MultipleBrowsersProjectPath + javaRelativeResultsPath;

			String junit4SingleBrowserProjectPath = webAppFolder + "/junit4-web-single-browser-test";
			String junit4SingleBrowserResultsPath = junit4SingleBrowserProjectPath + javaRelativeResultsPath;

			/* *** TJob 5 *** */
			String tJob5Name = "Junit4 Multi Browser Test";
			String commands5 = "git clone https://github.com/elastest/demo-projects;\ncd "
					+ junit4MultipleBrowsersProjectPath + ";\nmvn -B -Dbrowser=chrome test;";
			etDataLoader.createTJob(project, tJob5Name, junit4MultipleBrowsersResultsPath, javaMvnImage, false,
					commands5, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
			...
			etDataLoader.createTJob(project, tJob6Name, junit4SingleBrowserResultsPath, javaMvnImage, false, commands6,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
			...
			String cucumberMultipleBrowsersProjectPath = webAppFolder + "/cucumber-web-multiple-browsers-test";
			String cucumberMultipleBrowsersResultsPath = cucumberMultipleBrowsersProjectPath + javaRelativeResultsPath;

			String cucumberSingleBrowserProjectPath = webAppFolder + "/cucumber-web-single-browser-test";
			String cucumberSingleBrowserResultsPath = cucumberSingleBrowserProjectPath + javaRelativeResultsPath;
			...
			etDataLoader.createTJob(project, tJob7Name, cucumberMultipleBrowsersResultsPath, javaMvnImage, false,
					commands7, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
			...
			etDataLoader.createTJob(project, tJob8Name, cucumberSingleBrowserResultsPath, javaMvnImage, false,
					commands8, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);

			/* *************************************** */
			/* **************** Gauge **************** */
			/* *************************************** */
			String gaugeMultipleBrowsersProjectPath = webAppFolder + "/gauge-web-multiple-browsers-test";
			String gaugeMultipleBrowsersResultsPath = gaugeMultipleBrowsersProjectPath + javaRelativeResultsPath;

			String gaugeSingleBrowserProjectPath = webAppFolder + "/gauge-web-single-browser-test";
			String gaugeSingleBrowserResultsPath = gaugeSingleBrowserProjectPath + javaRelativeResultsPath;
			...
			etDataLoader.createTJob(project, tJob9Name, gaugeMultipleBrowsersResultsPath, gaugeImage, false, commands9,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
			...
			etDataLoader.createTJob(project, tJob10Name, gaugeSingleBrowserResultsPath, gaugeImage, false, commands10,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);

			/* **************************************** */
			/* ************** Protractor ************** */
			/* **************************************** */
			String protractorMultiBrowsersProjectPath = webAppFolder + "/protractor-web-multiple-browsers-test";
			String protractorMultiBrowsersResultsPath = protractorMultiBrowsersProjectPath
					+ jasmineAndProtractorRelativeResultsPath;

			String protractorSingleBrowserProjectPath = webAppFolder + "/protractor-web-single-browser-test";
			...
			etDataLoader.createTJob(project, tJob11Name, protractorMultiBrowsersResultsPath, nodeImage, false,
					commands11, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
			...
			etDataLoader.createTJob(project, tJob12Name, protractorSingleBrowserResultsPath, nodeImage, false,
					commands12, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);

			/* **************************************** */
			/* **************** Python **************** */
			/* **************************************** */

			String pythonMultipleBrowsersProjectPath = webAppFolder + "/python-web-multiple-browsers-test";
			String pythonMultipleBrowsersResultsPath = pythonMultipleBrowsersProjectPath + pythonRelativeResultsPath;

			String pythonSingleBrowserProjectPath = webAppFolder + "/python-web-single-browser-test";
			String pythonSingleBrowserResultsPath = pythonSingleBrowserProjectPath + pythonRelativeResultsPath;
			...
			etDataLoader.createTJob(project, tJob13Name, pythonMultipleBrowsersResultsPath, pythonImage, false,
					commands13, EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
			...
			etDataLoader.createTJob(project, tJob14Name, pythonSingleBrowserResultsPath, pythonImage, false, commands14,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
		}
	}
	...
	public void createOpenVidu() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			// Create Sut
			SutSpecification sut = etDataLoader.createSutDeployedByElastestWithCommands(project, null, sutName, sutDesc,
					sutImage, sutCommands, CommandsOptionEnum.IN_NEW_CONTAINER, sutProtocol, sutPort, null);

			// Create TJob
			etDataLoader.createTJob(project, tJobName, resultsPath, javaMvnImage, false, tJobCommands,
	...
	public void createFullteaching() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			etDataLoader.createTJob(project, tJobName1, resultsPath1, javaMvnImage, false, commands1,
			...
			etDataLoader.createTJob(project, tJobName2, resultsPath2, javaMvnImage, false, commands2,
					EXEC_DASHBOARD_CONFIG_FULLTEACHING, null, tss, sut, null);
			...
			etDataLoader.createTJob(project, tJobName3, resultsPath3, javaMvnImage, false, commands3,
					EXEC_DASHBOARD_CONFIG_FULLTEACHING, null, tss, sut, null);
		}
	}
	...
	private SutSpecification createAndGetFullteachingSut(Project project, String imageTag) {
		...
		return etDataLoader.createSutDeployedByElastestWithCompose(project, null, sutName, sutDesc, sutCompose,
				"full-teaching", sutProtocol, sutPort, null);
	}
	...
	private void createBrowsersInAWS() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			// Create Sut
			SutSpecification sut = etDataLoader.createSutDeployedOutsideAndInstrumentedByElastest(project, null,
					sutName, sutDesc, sutIP, sutProtocol, sutPort, null, sutUser, sutPass, sutPrivateKey, sutLogPaths,
					null, null, false);
	...
	private void createEMS() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			// Create Sut
			SutSpecification sut = etDataLoader.createSutDeployedByElastestWithCompose(project, null, sutName, sutDesc,
					sutCompose, mainService, sutProtocol, sutPort, null);

			// Create TJob
			etDataLoader.createTJob(project, tJobName, resultsPath, tJobImage, false, commands, EXEC_DASHBOARD_CONFIG,
					null, tss, sut, null);
		}
	...
	private void createEDS() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			// Create Sut
			SutSpecification sut = etDataLoader.createSutDeployedByElastestWithCommands(project, null, sutName, sutDesc,
					sutImage, sutCommands, CommandsOptionEnum.DEFAULT, sutProtocol, sutPort, null);
	...
	public void createQoE() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			...
			etDataLoader.createTJob(project, tJob1Name, testResultsPath, javaMvnImage, false, commands1,
					EXEC_DASHBOARD_CONFIG_WITH_SUT, null, tss, sut, null);
		}
	...
	public void createQoEAWS() {
		...
		if (!etDataLoader.projectExists(pjName)) {
			// Create Project
			this.printLog(pjName);
			project = etDataLoader.createProject(pjName);
		} else {
			// Get Project
			project = etDataLoader.getProject(pjName);
		}

		String sutName = "OpenVidu In AWS";
		if (!etDataLoader.sutExistsInProject(sutName, project)) {
			// Create Sut
			String sutDesc = "OpenViduServer In AWS";
			String sutIP = "Your OpenviduServer ip here";
			ProtocolEnum sutProtocol = ProtocolEnum.HTTPS;
	...
	public void createTestLink() {
		...
		if (!etDataLoader.tlProjectExists(pjName)) {
			...
			TestSuite suite = etDataLoader.createTlTestSuite(project.getId(), "Webapp Suite", "Suite of Webapp");
			...
			case1.setSummary("Add empty data and check if new entry is not empty. This test must always fail");
			case1.setPreconditions("The Webapp application must be available and must be clean of data");
			...
			case2.setSummary("Add data, press clear button and check if the data has been removed.");
			case2.setPreconditions("The Webapp application must be available and must be clean of data");

			case2 = etDataLoader.createTlTestCase(case2);

			TestCaseStep case2Step1 = etDataLoader.getNewCaseStep("Type 'MessageTitle' into Title field",
					"'MessageTitle' will be shown into Title field", 1);

			TestCaseStep case2Step2 = etDataLoader.getNewCaseStep("Type 'MessageBody' into Body field",
			...
			List<TestCaseStep> case2StepsList = Arrays.asList(case2Step1, case2Step2, case2Step3, case2Step4);
			...
			case3.setPreconditions("The Webapp application must be available and must be clean of data");
			case3 = etDataLoader.createTlTestCase(case3);

			TestCaseStep case3Step1 = etDataLoader.getNewCaseStep("Type 'MessageTitle' into Title field",
					"'MessageTitle' will be shown into Title field", 1);

			TestCaseStep case3Step2 = etDataLoader.getNewCaseStep("Type 'MessageBody' into Body field",
					"'MessageBody' will be shown into Body field", 2);
			...
			// Create Sut
			ExternalProject exProject = etDataLoader.getExternalProjectByTestProjectId(project.getId());
			SutSpecification sut = etDataLoader.createSutDeployedByElastestWithDockerImage(null, exProject,
					webAppSutName, webAppSutDesc, webAppSutImage, webAppSutProtocol, webAppSutPort, null);
