...
public class EtmFilesService {
    ...
    public List<ElastestFile> getTJobExecFilesUrls(Long tJobId, Long tJobExecId)
        ...
        try {
            filesList = this.getTJobExecFilesUrls(fileSeparator,
                    tJobExecFilePath);
    ...
    public List<ElastestFile> getTJobExecFilesUrls(String fileSeparator,
        ...
        if (file.exists()) {
            ...
            for (String folderName : folders) {
                ...
                filesList.addAll(this.getFilesByFolder(folder,
                        tJobExecFilePath + folderName + fileSeparator,
    ...
    public List<ElastestFile> getFilesByFolder(File folder, String relativePath,
            String folderName, String fileSeparator) throws IOException {
        ...
        for (String currentFileName : folderFilesNames) {
            ...
            if (currentFile.isDirectory()) {
                ...
                filesList.add(new ElastestFile(currentFileName,
                        ...
                        getFileUrl(relativeEncodedFilePath), folderName));
            }
        }
        return filesList;
    }
