...
/**
 * A class to wait until a condition becomes true. Periodically calls
 * {@link #until()} and sleeps for a specified amount of time if it returns
 * false. If {@link #until()} does not return true within the timeout, throws a
...
public abstract class Waiter {
     ...
     */
    public Waiter(String timeoutMessage) {
     ...
     *            the message in the {@link TimedOut} exception
     */
    public Waiter(int timeout, String timeoutMessage) {
     ...
     *            the timeout in milliseconds
     * @param sleep
     *            the time to sleep between calling {@link #until()}, in
     *            milliseconds
     */
    public Waiter(int timeout, int sleep) {
     ...
     *            the message in the {@link TimedOut} exception
     */
    public Waiter(int timeout, int sleep, String timeoutMessage) {
     ...
     * 
     * @throws TimedOut
     *             if {@link #until()} does not return true within in the
     *             timeout.
     * @throws Exception
     ...
     *             if {@link #until()} throws an exception
     */
    public void waitUntil(String timeoutMessage) throws TimedOut, Exception {
     ...
     * 
     * @param timeout
     *            the timeout in milliseconds, overrides the timeout in the
     *            constructor
     * @throws TimedOut
     *             if {@link #until()} does not return true within the timeout
     * @throws Exception
     *             if {@link #until()} throws an exception
     */
    public void waitUntil(int timeout) throws TimedOut, Exception {
     ...
     *            constructor
     * @param sleep
     *            the time between calls to {@link #until()}, in milliseconds,
     ...
     *             if {@link #until()} throws an exception
     */
    public void waitUntil(int timeout, int sleep) throws TimedOut, Exception {
